...
xy[1] = -105
print(xy, p_[0])
inax.annotate("$S_i \in S$", xytext = xy, xy = p_[0],
...
ax.format(abc=True, titleabove = 0)
# fig.auto_layout(resize = 0, tight = 0, aspect = 0)
fig.savefig("./figures/figure1_alt")
fig.show()
# plt.show(block=1)
